...
import (
	...
	"freechatgpt/pkg/plugins/service/wsstostream"
...
func (p *UnofficialApiProcess) response(response *http.Response, mid func(p *UnofficialApiProcess, a string) bool) error {
	...
	if p.Context.RequestParam == "/chat/completions" || p.Context.RequestParam == "/images/generations" {
